 ...
 */
        ...
        __pyx_t_14 = (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field.data + __pyx_t_13 * __pyx_v_field.strides[0]) ) + __pyx_t_4 * __pyx_v_field.strides[1]) )));
        __pyx_t_15 = __pyx_v_max_value;
        ...
        __pyx_t_4 = __pyx_v_yy;
        __pyx_t_13 = __pyx_v_xx;
        *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field.data + __pyx_t_4 * __pyx_v_field.strides[0]) ) + __pyx_t_13 * __pyx_v_field.strides[1]) )) = __pyx_t_16;
        __pyx_L7_continue:;
      }
    }
  }
