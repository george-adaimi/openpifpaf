...
class DCNCompositeLoss(torch.nn.Module):
    b_scale = 1.0
    def __init__(self, head_net: RefinedCompositeField3, regression_loss):
        super().__init__()
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument('--dcn-b-scale', default=DCNCompositeLoss.b_scale, type=float,
                           help='Laplace width b for scale lossin DCNComposite')

    @classmethod
    def configure(cls, args: argparse.Namespace):
        cls.b_scale = args.dcn_b_scale
