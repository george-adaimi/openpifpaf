...
class RelationPainter:
    def __init__(self, *, xy_scale=1.0, eval=False):
    ...
    def annotations(self, ax, annotations, *,
        ...
        for i, ann in reversed(list(enumerate(annotations))):
            ...
            this_color_rel = i#ann.category_id_rel - 1
            ...
            if self.G:
                self.draw_graph(ann, color=(this_color_sub, this_color_rel,this_color_obj), text=(text_sub, None, text_obj))
        if self.G:
